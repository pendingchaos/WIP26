...
int main() {
    ...
    float* posx_arr = (float*)system.attributes[get_attribute_index(&program, "position.x")];
    float* posy_arr = (float*)system.attributes[get_attribute_index(&program, "position.y")];
    float* posz_arr = (float*)system.attributes[get_attribute_index(&program, "position.z")];
    float* velx_arr = (float*)system.attributes[get_attribute_index(&program, "velocity.x")];
    float* vely_arr = (float*)system.attributes[get_attribute_index(&program, "velocity.y")];
    float* velz_arr = (float*)system.attributes[get_attribute_index(&program, "velocity.z")];
    float* accx_arr = (float*)system.attributes[get_attribute_index(&program, "accel.x")];
    float* accy_arr = (float*)system.attributes[get_attribute_index(&program, "accel.y")];
    float* accz_arr = (float*)system.attributes[get_attribute_index(&program, "accel.z")];
    float* colx_arr = (float*)system.attributes[get_attribute_index(&program, "colorrgb.x")];
    float* coly_arr = (float*)system.attributes[get_attribute_index(&program, "colorrgb.y")];
    float* colz_arr = (float*)system.attributes[get_attribute_index(&program, "colorrgb.z")];
    start = get_time();
    for (size_t i = 0; i < 1000000; i++) {
